...
<!-- Right: Login Form -->
    ...
    <form action="<?php echo e(route('finduser')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <!-- Username Input -->
        <div class="mb-4 ">
        <label for="username" class="block text-gray-800">User Email</label>
        <input type="email" id="username" name="email" value="<?php echo e(old('email')); ?>" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" >
...
unset($__errorArgs, $__bag); ?>
        ...
        <input type="number"  name="contact" value="<?php echo e(old('contact')); ?>" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500">
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\pompalace\resources\views/layout/forgetpassword.blade.php ENDPATH**/ ?>