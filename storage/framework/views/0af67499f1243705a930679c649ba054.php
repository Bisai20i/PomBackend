...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('dashboardContent', null, []); ?> 
        ...
        <div class="p-2 p-md-4 p-lg-5 overflow-y-auto">
            ...
            <form action="<?php echo e(route('dogs.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-2 flex gap-4 w-100 justify-center">
                    ...
                    <input type="text" name="dogname" value="<?php echo e(old('dogname')); ?>" class="w-64 border border-gray-300 rounded-md py-1 px-2  focus:outline-none focus:border-blue-500" required >
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input type="number" name="dogprice" value="<?php echo e(old('dogprice')); ?>" class="w-64 border border-gray-300 rounded-md py-1 px-2 focus:outline-none focus:border-blue-500" required >
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-2 flex justify-center">
                    ...
                    <textarea name="dogdescription" rows="3" class="w-full border border-gray-300 rounded-md py-1 px-2 focus:outline-none focus:border-blue-500" required ><?php echo e(old('dogdescription')); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\laravel\pompalace\resources\views/dashboard/addDogs.blade.php ENDPATH**/ ?>